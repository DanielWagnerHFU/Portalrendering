...
namespace FudgeCore {
  ...
  export class ComponentCamera extends Component {
    ...
    protected mtxProjection: Matrix4x4 = new Matrix4x4; // The matrix to multiply each scene objects transformation by, to determine where it will be drawn.
    protected projection: PROJECTION = PROJECTION.CENTRAL;
    protected fieldOfView: number = 45; // The camera's sensorangle.
    protected aspectRatio: number = 1.0;
    protected direction: FIELD_OF_VIEW = FIELD_OF_VIEW.DIAGONAL;
    protected near: number = 1;
    protected far: number = 2000;
    protected backgroundEnabled: boolean = true; // Determines whether or not the background of this camera will be rendered.
